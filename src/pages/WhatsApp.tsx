...
import { MessageSquare, Bot, Send, User, Search, Plus, Phone, CheckCircle, X, Paperclip, File, Image as ImageIcon, Video, Music, ChevronLeft } from 'lucide-react';
  ...
  return (
    <div className="absolute inset-0 flex flex-col">
      ...
      <div className="flex-1 bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden flex">
        ...
        <div className={`${selectedConv ? 'hidden md:flex md:w-1/3' : 'w-full md:w-1/3'} border-r border-gray-200 flex flex-col bg-gray-50`}>
          <div className="p-4 border-b border-gray-200 bg-white">
            <div className="relative">
              ...
              <input
                ...
                className="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-xl leading-5 bg-gray-50 placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-yellow-500 focus:border-yellow-500 text-base sm:text-sm"
              />
            </div>
          </div>
        ...
        {/* Main Chat Area */}
        <div className={`${selectedConv ? 'flex-1 flex flex-col' : 'hidden md:flex flex-1 flex-col items-center justify-center'} bg-[#efeae2]`}>
          {selectedConv ? (
            <>
              {/* Chat Header */}
              <div className="px-4 md:px-6 py-4 bg-white border-b border-gray-200 flex items-center justify-between shadow-sm z-10">
                <div className="flex items-center">
                  <button 
                    onClick={() => setSelectedConv(null)}
                    className="md:hidden mr-3 p-2 -ml-2 text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-full"
                  >
                  ...
                  <div>
                    <h2 className="text-lg font-medium text-gray-900 truncate max-w-[150px] sm:max-w-[200px]">{selectedConv.customer_name || selectedConv.customer_phone}</h2>
                ...
                <div className="flex items-center space-x-2">
                  <button
                    ...
                    disabled={isSending}
                    className="hidden sm:inline-flex items-center px-3 py-1.5 border border-gray-300 text-sm font-medium rounded-lg shadow-sm bg-white text-gray-700 hover:bg-gray-50 disabled:opacity-50"
                  >
                    Gerar Pré-Orçamento
                  </button>
                  <button
                  ...
                  >
                    ...
                    <span className="hidden sm:inline">{isBotActive ? 'Bot Ativo' : 'Ativar Bot'}</span>
                  </button>
                </div>
              </div>
              ...
              <div className="p-4 bg-[#f0f2f5] border-t border-gray-200">
                <form onSubmit={handleSendMessage} className="flex space-x-3 items-center">
                  ...
                  <input
                    ...
                    className="flex-1 block w-full rounded-full border-gray-300 shadow-sm py-3 px-5 focus:ring-yellow-500 focus:border-yellow-500 text-base sm:text-sm"
                    disabled={isSending}
                  />
                  <button
                    type="submit"
